...
static const yytype_int16 yyrline[] =
{
     ...
     341,   345,   351,   356,   360,   364,   370,   376,   381,   389,
     394,   403,   410,   414,   419,   426,   433,   437,   445,   450,
     455,   463,   469,   478,   483,   488,   496,   501,   510,   513,
     516,   522,   526,   533,   538,   545,   552,   562,   567,   574,
     584,   589,   596,   603,   610,   620,   625,   632,   642,   647,
     655,   660
};
#endif
...
#line 205 "parser.y"
			...
			(yyval.arrays)->list.push_back(unique_ptr<ExpAST>((yyvsp[-1].exp)));
		}
...
#line 217 "parser.y"
			...
			(yyval.initVal)->exp = unique_ptr<ExpAST>((yyvsp[0].exp));
		}
...
#line 345 "parser.y"
			...
			(yyval.stmt)->exp = unique_ptr<ExpAST>((yyvsp[-1].exp));
		}
...
#line 389 "parser.y"
				...
				(yyval.selectStmt)->cond = unique_ptr<CondAST>((yyvsp[-2].cond));
...
#line 394 "parser.y"
                                                      {
				(yyval.selectStmt) = new SelectStmtAST();
				(yyval.selectStmt)->cond = unique_ptr<CondAST>((yyvsp[-4].cond));
...
#line 403 "parser.y"
					...
					(yyval.iterationStmt)->cond = unique_ptr<CondAST>((yyvsp[-2].cond));
...
#line 410 "parser.y"
				...
				(yyval.returnStmt)->exp = unique_ptr<ExpAST>((yyvsp[-1].exp));
			}
...
#line 419 "parser.y"
               {
			(yyval.exp) = new ExpAST();
			(yyval.exp)->addExp = unique_ptr<AddExpAST>((yyvsp[0].addExp));
		}
...
#line 426 "parser.y"
               {
			(yyval.cond) = new CondAST();
			(yyval.cond)->lOrExp = unique_ptr<LOrExpAST>((yyvsp[0].lOrExp));
		}
...
#line 445 "parser.y"
				...
				(yyval.primaryExp)->exp = unique_ptr<ExpAST>((yyvsp[-1].exp));
...
#line 522 "parser.y"
				...
				(yyval.funcCParamList)->list.push_back(unique_ptr<ExpAST>((yyvsp[0].exp)));
			}
